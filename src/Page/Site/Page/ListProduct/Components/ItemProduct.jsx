        ...
        <>
            {
                data ?
                    data.map((item, index) => (
                        <div className="ItemProduct ItemProductHome SearchAuthor" key={index}>
                            <Link to={`/product-detail/${item.slug}`}>
                                <div className="ItemProduct_inner">
                                    <div className="ItemProduct_inner_image">
                                        <img style={{ width: '100%', height: '400px' }} src={`https://be-library-online.onrender.com/${item.images[0].image}`} alt={item.nameProduct} />
